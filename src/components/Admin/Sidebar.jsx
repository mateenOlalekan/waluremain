...
export default function Sidebar() {
  ...
  return (
    <div className={`${isCollapsed ? 'w-20' : 'w-80'} h-screen flex flex-col bg-gradient-to-b from-white to-gray-50/80 dark:from-gray-900 dark:to-gray-800 shadow-xl border-r border-gray-200/50 dark:border-gray-700/50 transition-all duration-500 ease-in-out backdrop-blur-sm relative group`}>
      ...
      {/* Navigation Sections */}
      <div className="flex-1 overflow-y-auto space-y-6 py-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
