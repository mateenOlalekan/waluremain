    ...
    <header className="bg-white shadow-md">
      <div className="flex items-center justify-between px-4 md:px-6 py-3">
        ...
        <div className="flex items-center gap-4">
          {/* Desktop: User info */}
          <p className="text-black font-medium hidden md:block">John Okafar</p>
          <div className="w-4 h-4 p-3.5  rounded-full bg-green-500 flex items-center justify-center text-white font-bold shadow">
            J
          </div>
          <button className="relative p-2 rounded-full bg-green-700 transition">
